...
public class EnemyHealthBar : MonoBehaviour 
{
	...
	private Camera cam;
	private Transform thisTransform; //get the transform
	private Transform camTransform; // get the camera transform
	...
	void Start () 
	{
		...
		{
        	cam = cameraToUse;//make sure always have our camera in use
		}
